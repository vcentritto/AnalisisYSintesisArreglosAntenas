        ...
        case 1            
            ...
            switch caso_especifico
                ...
                case 2
                    ...
                    d = input('        - La distancia inter-elemento del arreglo en dirección x e y: ');
            ...
            switch caso_especifico
                ...
                switch casoArreglosLinealesSintesis
                    case 1
                        ...
                        disp('--------------------------------------------------------------------------------------------------------------');
                        disp('INTRODUZCA LOS SIGUIENTES DATOS:');
                        N = input('       - El número de elementos del arreglo en dirección z: ');
                        d = input('       - La distancia inter-elemento del arreglo: ');
                        disp('--------------------------------------------------------------------------------------------------------------');
                        disp("¡IMPORTANTE!"); 
                        disp(['       ',num2str(f),' La posición del lóbulo principal ',num2str(theta),num2str(numero0),' debe estar entre 0° y 180°.']);
                        disp('--------------------------------------------------------------------------------------------------------------');
                        pTheta = input(['       - Ingrese la posición del lóbulo principal ',num2str(theta),num2str(numero0),': ']);
                        %Condición: Si se ingresa una posición del lóbulo principal que no esté entre 0° y 180°
                        while ((pTheta < 0) || (pTheta > 180))
                          disp('--------------------------------------------------------------------------------------------------------------');
                          disp(['¡LA POSICIÓN ',num2str(theta),num2str(numero0),' NO ES VÁLIDA!']); 
                          disp(['       ',num2str(f),' RECUERDE: la posición del lóbulo principal ',num2str(theta),num2str(numero0),' debe estar entre 0° y 180°.']);
                          disp('--------------------------------------------------------------------------------------------------------------');
                          pTheta = input(['       - Ingrese la posición del lóbulo principal ',num2str(theta),num2str(numero0),': ']);
                        end
                        disp('       - Elija el tipo de distribución de amplitud');
                ...
                case 2
                    ...
                    switch casoArreglosPlanoSintesis
                        case 1
                            ...
                            disp('--------------------------------------------------------------------------------------------------------------');
                            disp("¡IMPORTANTE!"); 
                            disp(['       ',num2str(f),' La posición del lóbulo principal (',num2str(theta),num2str(numero0),' y ',num2str(phi),num2str(numero0),') debe estar entre -90° y 90°.']);
                            disp('--------------------------------------------------------------------------------------------------------------');
                            pTheta = input(['        - Ingrese la posición del lóbulo principal ',num2str(theta),num2str(numero0),': ']);
                            pPhi = input(['        - Ingrese la posición del lóbulo principal ',num2str(phi),num2str(numero0),': ']);
                           %Condición Theta: Si se ingresa una posición del lóbulo principal que no esté entre -90° y 90°
                            while ((pTheta < -90) || (pTheta > 90))
                                disp('--------------------------------------------------------------------------------------------------------------');
                                disp(['¡LA POSICIÓN ',num2str(theta),num2str(numero0),' NO ES VÁLIDA!']); 
                                disp(['       ',num2str(f),' RECUERDE: la posición del lóbulo principal ',num2str(theta),num2str(numero0),' debe estar entre -90° y 90°.']);
                                disp('--------------------------------------------------------------------------------------------------------------');
                                pTheta = input(['       - Ingrese la posición del lóbulo principal ',num2str(theta),num2str(numero0),': ']);
                            end
                            ...
                            while ((pPhi < -90) || (pPhi > 90))
                                disp('--------------------------------------------------------------------------------------------------------------');
                                disp(['¡LA POSICIÓN ',num2str(phi),num2str(numero0),' NO ES VÁLIDA!']); 
                                disp(['       ',num2str(f),' RECUERDE: la posición del lóbulo principal ',num2str(phi),num2str(numero0),' debe estar entre -90° y 90°.']);
                                disp('--------------------------------------------------------------------------------------------------------------');
                                pPhi = input(['       - Ingrese la posición del lóbulo principal ',num2str(phi),num2str(numero0),': ']);
                            end
                            disp('        - Elija el tipo de distribución de amplitud');
                            ...
                            %Función de distribución de amplitud
                            [Amplitudes] = fDistribucionAmplitudPlano(N, verif);
                            %Para cortes cualquiera del diagrama
                            opcion = 1;
                            repetir = 5;
                        ...
                        case 2 
                            ...
                            disp('--------------------------------------------------------------------------------------------------------------');
                            disp("¡IMPORTANTE!"); 
                            disp(['       ',num2str(f),' Corresponde a Dolph-Chebyshev Mejorado ',num2str(f),' método desarrollado por Cheng-Tseng.']);
                            disp(['       ',num2str(f),' Los elementos del arreglo están sobre el plano xy.']);
                            disp(['       ',num2str(f),' Se estudian arreglos de perímetro y malla cuadrada.']);
                            disp(['       ',num2str(f),' El número de elementos es igual en ambas direcciones (Nx = Ny).']);
                            disp(['       ',num2str(f),' La distancia inter-elemento es igual en ambas direcciones (dx = dy).']);
                           ...
                           %Condición Theta: Si se ingresa una posición del lóbulo principal que no esté entre -90° y 90°
                            ...
                            disp('--------------------------------------------------------------------------------------------------------------');
                            disp("¡IMPORTANTE!"); 
                            disp(['       ',num2str(f),' El nivel relativo de lóbulos laterales (adim) es ',num2str(nivelRelativoAdim)]);         
                            disp('--------------------------------------------------------------------------------------------------------------');
                            %Para cortes cualquiera del diagrama
                            opcion = 1;
                            repetir = 5;
                        ...
                        case 3
                            ...
                            disp('--------------------------------------------------------------------------------------------------------------');
                            disp("¡IMPORTANTE!"); 
                            disp(['       ',num2str(f),' La configuración geométrica de los arreglos canónicos es romboidal.']);
                            disp(['       ',num2str(f),' Es necesario indicar las coordenadas (',num2str(theta),',',num2str(phi),') de los nulos (en grados).']); 
                            disp(['       ',num2str(f),' Se aceptan 3 nulos como MÍNIMO y 27 como MÁXIMO']);
                            disp('--------------------------------------------------------------------------------------------------------------');
                            disp("INTRODUZCA LOS SIGUIENTES DATOS:"); 
                            ...
                            elseif CN > 27
                                ...
                                disp(['        - A continuación, ingrese las coordenadas (',num2str(theta),num2str(letraN),',',num2str(phi),num2str(letraN),') para cada nulo:'])
                                for i = 1:1:CN
                                    col = 1;
                                ...
                                %Imagen de configuración del arreglo
                                im = imread('imagenPrevia.png');
                                scale = 0.35; 
                                im_resized = imresize(im, scale);
                                figure('Name','Arreglo canónico implementado en este programa');
                                imshow(uint8(im_resized));
                                truesize;
                                %Título y subtítulo concatenado
                                cad1Laxpati = '{\bf\fontsize{20} Geometría del arreglo canónico}';
                                ...
                                disp(['       ',num2str(f),' La imagen describe la configuración romboidal de un arreglo canónico.']);
                                disp(['       ',num2str(f),' Los vectores d',num2str(numero1),' y d',num2str(numero2),' describen la posición especial de cada elemento del arreglo canónico.']);
                                ...
                                disp(['       ',num2str(f),' DEBE definir los módulos d',num2str(numero1),' y d',num2str(numero2),' de los vectores d',num2str(numero1),' y d',num2str(numero2),'.']);
                                disp('--------------------------------------------------------------------------------------------------------------');
                                d1 =  input(['        - Ingrese el módulo d',num2str(numero1),' (distancia del origen al elemento en el eje x): ']);
                                d2 =  input(['        - Ingrese el módulo d',num2str(numero2),' (distancia del origen al elemento en el eje y): ']);
                                disp('--------------------------------------------------------------------------------------------------------------');
                                close all
                                disp(' ');
                                %Funciones
