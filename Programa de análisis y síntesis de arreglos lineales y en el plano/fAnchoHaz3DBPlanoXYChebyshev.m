...
figure('Name','Corte del diagrama de radiación en phi0 (Ancho del haz, máximos y nulos)');
...
cad1Phi = ['{\bf\fontsize{20} Corte del diagrama en \phi_{0} = ', num2str(pPhi), 'º}'];
cad2Phi = '{\it\fontsize{14} Ancho del haz, máximos y nulos}';
...
if pTheta == 0
    ...
    maxDesfasajeAmbosParaTheta = 0;
    posicionMaxDesfasajeAmbosParaTheta = 0;
else
    ...
    if length(ordenCasoTheta) == 1
        ...
        set(ax,'FontName', 'Times New Roman','FontSize', 15);
        %Título y subtítulo concatenado
        cad1para4elementos = ['{\bf\fontsize{20} Corte del diagrama en \theta_{0} = ', num2str(pTheta), 'º}'];
        cad2para4elementos = '{\it\fontsize{14} Ancho del haz, máximos y nulos}';
        ...
        if anchoDeHaz3dBParaTheta == 0
            ...
            %Se realiza línea de ancho de haz a - 3 dB
        ...
        set(ax,'FontName', 'Times New Roman','FontSize', 15);
        %Título y subtítulo concatenado
        cad1Theta = ['{\bf\fontsize{20} Corte del diagrama en \theta_{0} = ', num2str(pTheta), 'º}'];
        cad2Theta = '{\it\fontsize{14} Ancho del haz, máximos y nulos}';
